 ...
 */
  ...
  vector<unsigned int> peaks_0;   // Single chargeg b-y ions, in case of exact p-value, this contains only the b-ions
  vector<unsigned int> peaks_1;   // Double chargeg b-y ions
